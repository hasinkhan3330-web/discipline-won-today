...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Notice — DWT by NX AI" },
      { name: "description", content: "How NX AI collects, uses, and protects your personal data in the DWT application." },
      { property: "og:title", content: "Privacy Notice — DWT" },
      { property: "og:description", content: "NX AI's privacy practices for the DWT app." },
...
function Privacy() {
  return <LegalShell title="PRIVACY NOTICE">
    ...
    <p>This Privacy Notice explains how <b>NX AI</b> ("we", "us", "our"), the operator of the Discipline Won Today ("DWT") application, collects, uses, and shares your personal data. NX AI is the data controller for the personal data described here.</p>

    <h2>1. Who We Are</h2>
    <p>NX AI is a technology company. DWT is one of our products — a discipline and habit-tracking application. If you have questions about this notice, contact us at <b>support@nx-ai.app</b>.</p>
    ...
    <ul>
      ...
      <li><b>Payment data:</b> handled entirely by our Merchant of Record, Paddle.com. We receive only a customer ID, subscription status, and billing period — never card numbers.</li>
    </ul>

    <h2>3. How We Use Your Data</h2>
    <ul>
      <li>To create and manage your account (contract performance).</li>
      <li>To provide the DWT service — tracking, verification, leaderboards, meditation (contract performance).</li>
    ...
    <ul>
      <li><b>Paddle.com Market Ltd</b> — Merchant of Record for all payments, subscription management, tax compliance, and invoicing.</li>
    ...
    <p>Where personal data leaves the UK / EEA, we rely on Standard Contractual Clauses or equivalent safeguards. Paddle acts as an independent controller for payment data and applies its own safeguards.</p>

    <h2>6. Data Retention</h2>
    <p>We retain account data for as long as your account is active. If you delete your account, we delete or anonymise your personal data within 90 days, except where retention is required by law (e.g. tax records held by Paddle for up to 10 years).</p>

    <h2>7. Your Rights</h2>
    <p>Depending on your location, you may have the right to access, rectify, erase, restrict, port, or object to processing of your personal data, and to withdraw consent. You may also lodge a complaint with your local supervisory authority. To exercise these rights, contact <b>support@nx-ai.app</b>. We respond within one month.</p>
    ...
    <h2>9. Cookies</h2>
    <p>DWT uses only essential cookies and local storage required to keep you signed in and remember preferences. We do not use marketing or third-party analytics cookies.</p>
