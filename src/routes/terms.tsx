...
function Terms() {
  return <LegalShell title="TERMS & CONDITIONS">
    ...
    <p>By continuing to use AXEN, you agree to these Terms. You must provide accurate information, keep your account credentials confidential, and are responsible for all activity under your account.</p>
