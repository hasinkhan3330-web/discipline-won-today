...
const QUOTES = [
  ...
  { p: "TOM CRUISE", q: "I won't give up. No matter what happens, I will keep pushing.", img: wiki("Tom_Cruise_by_Gage_Skidmore_2.jpg") },
  { p: "LEONARDO DICAPRIO", q: "If you can do what you do best and be happy, you're further along in life than most people.", img: wiki("Leonardo_DiCaprio_2019.jpg") },
  { p: "WILL SMITH", q: "The first step before anybody else in the world believes it is you have to believe it.", img: wiki("TechCrunch_Disrupt_SF_2013_(Day_2)_(9728645640)_(cropped).jpg") },
  { p: "DENZEL WASHINGTON", q: "Dreams without goals are just dreams.", img: wiki("Denzel_Washington_2018.jpg") },
  { p: "MORGAN FREEMAN", q: "How do we change the world? One random act of kindness at a time.", img: wiki("Morgan_Freeman_Deauville_2018.jpg") },
  { p: "JACKIE CHAN", q: "Do not let circumstances control you. You change your circumstances.", img: wiki("Jackie_Chan_July_2016.jpg") },
  { p: "USAIN BOLT", q: "I trained four years to run nine seconds. People give up when they don't see results in two months.", img: wiki("Usain_Bolt_Rio_100m_final_2016k.jpg") },
  { p: "ROGER FEDERER", q: "You have to put in a lot of sacrifice and effort for sometimes little reward.", img: wiki("Roger_Federer_(26_June_2009,_Wimbledon)_2_new.jpg") },
  { p: "RAFAEL NADAL", q: "Endurance, determination, and hard work — three things that never fail.", img: wiki("R_Nadal_Madrid_Open_2021.jpg") },
  { p: "NOVAK DJOKOVIC", q: "I always try to see the positive side of things, whether it's obstacle or opportunity.", img: wiki("Novak_Djokovic_Queen%27s_Club_2018_5.jpg") },
  { p: "LEBRON JAMES", q: "You have to be able to accept failure to get better.", img: wiki("LeBron_James_%2851959977144%29_(cropped2).jpg") },
  { p: "STEPHEN CURRY", q: "Success is not an accident, success is a choice.", img: wiki("Stephen_Curry_shooting_%28cropped%29.jpg") },
  { p: "TIGER WOODS", q: "No matter how good you get you can always get better and that's the exciting part.", img: wiki("Tiger_Woods_in_May_2019.jpg") },
  { p: "SERENA WILLIAMS", q: "I really think a champion is defined not by their wins but by how they can recover when they fall.", img: wiki("Serena_Williams_at_2013_US_Open.jpg") },
  { p: "OPRAH WINFREY", q: "The biggest adventure you can take is to live the life of your dreams.", img: wiki("Oprah_in_2014.jpg") },
  { p: "BARACK OBAMA", q: "The best way to not feel hopeless is to get up and do something.", img: wiki("President_Barack_Obama.jpg") },
  { p: "NARENDRA MODI", q: "Dreams are those which don't let you sleep — that's when they get converted into reality.", img: wiki("Prime_Minister_Narendra_Modi.jpg") },
  { p: "MUKESH AMBANI", q: "Think big, think fast, think ahead. Ideas are no one's monopoly.", img: wiki("Mukesh_Ambani.jpg") },
  { p: "GAUTAM ADANI", q: "Growth with goodness has been the guiding philosophy of my life.", img: wiki("Gautam_Adani_2022.jpg") },
  { p: "N.R. NARAYANA MURTHY", q: "The real power of money is the power to give it away.", img: wiki("Infosys_Founder,_N._R._Narayana_Murthy_(cropped).jpg") },
  { p: "STEPHEN HAWKING", q: "However difficult life may seem, there is always something you can do and succeed at.", img: wiki("Stephen_Hawking.StarChild.jpg") },
  { p: "NIKOLA TESLA", q: "The present is theirs; the future, for which I really worked, is mine.", img: wiki("Tesla_circa_1890.jpeg") },
  { p: "MOTHER TERESA", q: "Do small things with great love.", img: wiki("MotherTeresa_090.jpg") },
  { p: "WALT DISNEY", q: "The way to get started is to quit talking and begin doing.", img: wiki("Walt_Disney_1946.JPG") },
  { p: "HENRY FORD", q: "Whether you think you can or you can't, you're right.", img: wiki("Henry_ford_1919.jpg") },
  { p: "JEAN-CLAUDE VAN DAMME", q: "You are one workout away from a good mood.", img: wiki("Jean-Claude_Van_Damme_(2012)_(cropped).jpg") },
  { p: "JASON STATHAM", q: "The harder you work, the more you get done, the more time you have.", img: wiki("Jason_Statham_by_Gage_Skidmore.jpg") },
  { p: "CHRIS HEMSWORTH", q: "Discipline outweighs motivation every single day.", img: wiki("Chris_Hemsworth_by_Gage_Skidmore_2.jpg") },
  { p: "TONY ROBBINS", q: "The path to success is to take massive, determined action.", img: wiki("Tony_Robbins_-_Unleash_the_Power_Within,_London_-_2019_(48918961658)_(cropped).jpg") },
  { p: "JIM ROHN", q: "Discipline is the bridge between goals and accomplishment.", img: wiki("Portrait_Gandhi.jpg") },
  { p: "NEYMAR JR", q: "It is not about being the best. It is about being better than you were yesterday.", img: wiki("Bra-Cos_(6)_(cropped).jpg") },
  { p: "KYLIAN MBAPPÉ", q: "Chase your dream — never stop. Never let anyone say you can't do it.", img: wiki("Kylian_Mbapp%C3%A9_2018.jpg") },
];
