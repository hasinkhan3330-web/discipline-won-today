...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      { title: "Refund Policy — DWT by NX AI" },
      { name: "description", content: "30-day money-back guarantee on DWT subscriptions. How to request a refund." },
      { property: "og:title", content: "Refund Policy — DWT" },
      { property: "og:description", content: "30-day money-back guarantee on all DWT plans." },
...
function Refund() {
  return <LegalShell title="REFUND POLICY">
    ...
    <p>NX AI ("we", "us"), operator of the Discipline Won Today ("DWT") application, offers a fair refund policy for all subscribers.</p>

    <h2>1. 30-Day Money-Back Guarantee</h2>
    <p>We offer a <b>30-day money-back guarantee</b>. If you are not satisfied with your DWT subscription, you may request a full refund within 30 days of your order date.</p>
